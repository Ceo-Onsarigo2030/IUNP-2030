  ...
  return (
    <div className="bg-cream min-h-screen">
      ...
      <section className="container py-14 sm:py-20">
        ...
        <div className="text-center mt-16 pt-10 border-t border-black/5">
          <p className="text-ink/60 mb-4">Not a member yet? Join UniNexus Connect to stay updated on every category.</p>
          <a href="/auth" className="btn-gold">Join UniNexus</a>
        </div>
      </section>
    </div>
  );
